...
from custom_dataset import LongMatchOrNoGame, CustomImageDataset
...
if __name__ == '__main__':
    ...
    # model_file_name = 'visuals/final/omni-lrmatch/func_omni_lrmatch_model.pkl'
    # model_file_name = 'visuals/check-in/noise-lrmatch/functionalnn_noise.pkl'
    # model_file_name = 'visuals/check-in/displacement-lrmatch/functionalnn_displacement.pkl'
    model_file_name = 'visuals/check-in/rotation-lrmatch/functionalnn_rot.pkl'
    encoder_file = 'encoder-.011.pkl'
    mem_encoder = pickle.load(open(encoder_file, 'rb'))

    recognizer = pickle.load(open(model_file_name, 'rb'))
